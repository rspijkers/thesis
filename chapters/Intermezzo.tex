...
\section{TEMP: 2 ways to determine the systematics for the correlation analysis}
  ...
  In any case I'll take 3\% as an estimate of the material budget uncertainty. The MC closure test is consistent within 1 roger-barlow standard deviation, so it is not considered as a source of systematic uncertainty. 

  \subsection{Take the systematics from the spectra analysis}

    This comes down to a flat 1.5\% uncertainty from the topological selection criteria, a sub-percent level contribution from sideband definition for the SB correlations\footnote{only in OS and Subtracted case}, and a 3\% uncertainty from the material budget, added in quadrature. We can even take the topological uncertainty to be lower than 1.5\% - as the material budget uncertainty is the dominant source of systematic uncertainty, the exact value of the topological selection criteria uncertainty doesn't have a large effect on the total systematic uncertainty.
    For the OS-SS we then compute it using the absolute values of the systematic uncertainties on the OS and SS respectively, assuming they are fully correlated. The results are presented in Figure \ref{fig:SystematicsSpec}.
  ...
  \subsection{Take the systematics from the correlation analysis}
    ...
    \begin{figure}[ht]
      ...
      \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/Intermezzo/systematics/systematics_OS_corr.pdf}
      ...
      \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/Intermezzo/systematics/systematics_SS_corr.pdf}
      ...
      \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/Intermezzo/systematics/systematics_Sub_corr.pdf}
        \caption{OS - SS with systematic uncertainties computed from the correlation analysis.}
        \label{fig:SystematicsSubCorr}
      \end{subfigure}
      \caption{Systematic uncertainties for the OS, SS, and OS - SS correlation results, computed from the correlation analysis.}
